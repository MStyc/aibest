...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen w-full bg-black flex overflow-hidden">
      ...
      {/* Main Chat Area */}
      <div className={`flex-1 flex flex-col ${activeProfile.theme || "bg-animated-blue-purple"} ${isMobile ? 'h-screen' : ''}`}>
        {/* Mobile-Optimized Header */}
        <div className={`flex items-center justify-between ${isMobile ? 'px-4 py-3' : 'p-4'} bg-black/90 backdrop-blur-sm border-b border-white/10`}>
          <div className="flex items-center flex-1 min-w-0">
            ...
            />
            <div className="flex-1 min-w-0">
              <h2 className={`text-white font-semibold ${isMobile ? 'text-lg' : 'text-lg'} truncate`}>{activeProfile.name}</h2>
      ...
      <div className={`${isMobile ? 'px-4 py-3' : 'p-4'} bg-black/90 backdrop-blur-sm border-t border-white/10`}>
        <div className={`flex items-center bg-white/10 backdrop-blur-sm rounded-full ${isMobile ? 'px-3 py-2' : 'px-4 py-2'} border border-white/10`}>
          {isMobile && (
